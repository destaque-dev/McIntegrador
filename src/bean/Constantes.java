...
public class Constantes {
    ...
    public static final String ATV_INSERE_DOCUMENTO = "INSEREDOCUMENTO";

    public static final String ATUALIZA_DOCUMENTO = "ATUALIZADOCUMENTO";

    public static final String ATV_PESQUISA_CLIENTE = "SEARCH";
